    ...
    <div className="relative min-h-screen">
      ...
      <section className="relative pt-32 pb-20 max-w-7xl mx-auto px-6 text-center">
        <ScrollReveal direction="up" duration={0.8}>
          <h1 className="font-display text-5xl md:text-6xl font-extrabold text-primary mb-6 tracking-tight">
          ...
          <div className="flex justify-center gap-4">
            <Link href="/signup" className="bg-primary text-white font-display font-semibold px-8 py-4 rounded-lg hover:bg-[#35577D] transition-all shadow-lg hover:shadow-xl active:scale-95">
              Try GPA Calculator
            </Link>
            <Link href="/help" className="bg-white border-2 border-primary text-primary font-display font-semibold px-8 py-4 rounded-lg hover:bg-slate-50 transition-all active:scale-95">
              View Demo
            </Link>
          </div>
        </ScrollReveal>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <ScrollReveal direction="up" delay={0.2}>
          <div className="mb-16 text-center md:text-left">
            <h2 className="font-display text-3xl font-bold text-primary">Core Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: "calculate", title: "GPA & CGPA Calculator", desc: "Fast, accurate calculations for individual semesters or your entire degree. Set target grades and see exactly what you need to hit your goals." },
            { icon: "smart_toy", title: "AI Guidance Counselor", desc: "Get instant, 24/7 academic advice from our custom-tuned AI. From course selection to study strategies, your mentor is always available.", highlight: true },
            { icon: "task_alt", title: "Student Task Manager", desc: "Stay organized with a productivity hub built for academic life. Track deadlines, prioritize assignments, and sync with your course calendar." },
            { icon: "analytics", title: "Result Checker & Analytics", desc: "Visualize your academic performance over time. Understand your strengths and identify areas for improvement with detailed data insights." },
          ].map((item, i) => (
      ...
      <section className="py-24 relative overflow-hidden bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative bg-white p-8 rounded-2xl shadow-2xl border border-slate-100 overflow-hidden">
                <div className="flex justify-between items-center mb-8">
                  <h4 className="font-display font-bold text-lg text-primary">Student Success Score</h4>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-4 bg-slate-50 rounded-xl">
                    <div className="flex items-center gap-3">
                      <span className="material-symbols-outlined text-[#35577D]">trending_up</span>
          ...
          <ScrollReveal direction="right">
            <div>
              <h2 className="font-display text-4xl font-bold text-primary mb-8">Why Academia?</h2>
              <div className="space-y-8">
                {[
                  ...
                  { icon: "query_stats", title: "Data-Driven Decisions", desc: "Stop guessing which courses to take. Use hard data and AI-powered insights to choose the path that maximizes your strengths." },
                  { icon: "all_inclusive", title: "Cohesive Experience", desc: "One hub for everything. Tasks, calculations, grades, and mentoring—all synced and working in harmony for your success." },
                ].map((item, i) => (
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 text-center">
        <ScrollReveal direction="up" distance={50}>
          <div className="bg-primary rounded-3xl p-16 text-white overflow-hidden relative shadow-2xl">
            ...
            <h2 className="font-display text-4xl font-bold mb-6 relative z-10">Ready to reach your academic goals?</h2>
            <p className="text-xl text-slate-300 mb-10 relative z-10 font-body">Get started for free today and join thousands of students tracking their way to excellence.</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
              <Link href="/signup" className="bg-white text-primary font-display font-bold px-10 py-4 rounded-lg hover:bg-slate-100 transition-all active:scale-95 shadow-xl">
                Get Started Free
              </Link>
              <Link href="/help" className="bg-transparent border-2 border-white/30 text-white font-display font-bold px-10 py-4 rounded-lg hover:bg-white/10 transition-all active:scale-95">
                Talk to an Advisor
              </Link>
            </div>
          </div>
