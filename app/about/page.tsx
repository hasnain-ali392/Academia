      ...
      <main className="pt-20">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            <FadeUp>
              <h1 className="font-headline text-4xl md:text-5xl lg:text-7xl text-primary font-bold mb-6 leading-tight tracking-tight">
                Empowering the <br />Future of <span className="text-secondary italic underline decoration-secondary/15 underline-offset-8">Academic Strategy.</span>
              </h1>
            </FadeUp>
            <FadeUp delay={0.2}>
        ...
        <section className="py-24 bg-primary relative overflow-hidden text-center">
          ...
          <div className="max-w-3xl mx-auto px-8 relative z-10">
            <FadeUp>
               <span className="font-display text-accent text-[11px] font-bold tracking-[0.4em] uppercase mb-10 block opacity-60">Strategic Vision</span>
            </FadeUp>
            <FadeUp delay={0.2}>
               <blockquote className="font-headline text-3xl md:text-5xl text-white italic leading-tight tracking-tight mb-12">
                 "To establish the global standard for academic data orchestration, empowering every scholar with the clarity of a strategic trajectory."
               </blockquote>
            </FadeUp>
            <FadeUp delay={0.3} className="text-accent space-y-1">
               <p className="font-headline font-bold text-xl">— Academia Command</p>
               <p className="text-[10px] tracking-[0.2em] uppercase opacity-40">Engineering clarity in education.</p>
            </FadeUp>
            <FadeUp delay={0.4} className="mt-14">
               <Button variant="secondary" className="px-10 shadow-xl shadow-secondary/5 border-secondary hover:bg-white hover:text-primary">
                  Activate Protocol
               </Button>
            </FadeUp>
          </div>
