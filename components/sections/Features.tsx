    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="text-center mb-16">
          <FadeUp>
            <h2 className="font-headline text-3xl md:text-4xl text-primary font-bold mb-4 tracking-tight">
              The Pillars of Academia
            </h2>
          </FadeUp>
          <FadeUp delay={0.1}>
            <p className="text-slate-500 max-w-xl mx-auto font-body text-[15px] leading-relaxed">
              Modern solutions for modern students, integrated into one seamless
              platform.
            </p>
          </FadeUp>
        </div>
        ...
        <StaggerGroup className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, idx) => (
            ...
            >
              ...
              <h3 className="font-headline font-bold text-primary text-lg mb-3 tracking-tight group-hover:text-secondary transition-colors">
                {feature.title}
              </h3>
              <p className="text-slate-600 text-[13px] mb-6 leading-relaxed min-h-[64px] font-body">
                {feature.desc}
              </p>
              <motion.div className="flex items-center gap-2 text-secondary font-display font-bold text-[11px] tracking-[0.1em] uppercase opacity-0 group-hover:opacity-100 transition-all transform translate-x-[-10px] group-hover:translate-x-0 whitespace-nowrap">
                Explore Tool
