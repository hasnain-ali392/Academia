        ...
        <FadeUp>
          <div className="bg-primary rounded-[2.5rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-primary/10">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <span className="font-display text-accent text-[11px] font-bold tracking-[0.4em] uppercase mb-8 block">Ready to Begin?</span>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <Link href="/signin">
                  <Button 
                    variant="ghost" 
                    className="px-8 py-3.5 text-sm text-white/80 border-white/10 hover:border-white hover:bg-white/5"
                  >
                     Sign In
                  </Button>
                </Link>
